...
const SCENES = [
  ...
  ['sites-open', () => { sitesMapOn = false; mapSelected = null; setSiteFilter('open'); navigateTo('sites') }],
  ['sites-map', () => { sitesMapOn = true; mapSelected = 'Claveria Well'; setSiteFilter('all'); navigateTo('sites'); sitesMapOn = false; mapSelected = null }],
